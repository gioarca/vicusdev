...
function Delete() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return fetch("".concat(baseURL, "/borghi?page=").concat(currentPage));
            case 5:
            ...
            case 8:
              ...
              // Unire i dati esistenti con i nuovi dati senza duplicati
              allBorghi = [].concat(_toConsumableArray(borghi), _toConsumableArray(initialBorghi)); // Creare un set per evitare duplicati
              uniqueBorghi = Array.from(new Set(allBorghi.map(function (borgo) {
                return borgo._id;
              }))).map(function (id) {
                return allBorghi.find(function (borgo) {
                  return borgo._id === id;
                });
              });
              setBorghi(uniqueBorghi.sort(function (a, b) {
  ...
  var handleDeleteBorgo = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(borgoId) {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return fetch("".concat(baseURL, "/borghi/").concat(borgoId), {
              method: "DELETE",
              headers: {
                "Content-Type": "application/json"
              }
          ...
          case 4:
            ...
            alert("Borgo cancellato con successo!");
            setBorghi(function (prevBorghi) {
              return prevBorghi.filter(function (borgo) {
                return borgo._id !== borgoId;
              });
            });
            navigate("/borghi");
            _context2.next = 16;
          ...
          case 14:
            ...
            _context2.t0.error.call(_context2.t0, "Errore durante la cancellazione del borgo:", _context2.t1);
          case 16:
            _context2.next = 21;
            break;
          case 18:
            ...
            console.error("Errore durante la richiesta DELETE:", _context2.t2);
          case 21:
          case "end":
    ...
    return function handleDeleteBorgo(_x) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_framerMotion.motion.div, {
  ...
  }, /*#__PURE__*/_react["default"].createElement("p", null, t("deleteBorgo", "Cancella Borgo"))), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      className: "flex flex-col text-center justify-center font-semibold mt-5"
    }, borgo.name || "Nome non disponibile"), /*#__PURE__*/_react["default"].createElement("button", {
      onClick: function onClick(e) {
        e.stopPropagation();
        handleDeleteBorgo(borgo._id);
      }
    }, /*#__PURE__*/_react["default"].createElement(_solid.XMarkIcon, {
      className: "float-right my-3 mx-5 h-6 text-red-500"
    })));
  })));
}
