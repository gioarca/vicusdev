...
function _arrayWithHoles(r) { if (Array.isArray(r)) return r; } // import { PencilIcon } from "@heroicons/react/outline";
...
function UpdateBorgo() {
  ...
  var borgoFunction = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("".concat(baseURL, "/borghi/").concat(params._id) // `http://localhost:3000/borghi/${params._id}`
            );
          case 3:
          ...
          case 10:
            ...
            console.error("Errore durante il fetching del borgo:", _context.t0);
          case 13:
          case "end":
  ...
  var _useState5 = (0, _react.useState)({
    ...
    borgoData = _useState6[0],
    setBorgoData = _useState6[1];
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 2;
              _context2.next = 5;
              return fetch("".concat(baseURL, "/borghi/").concat(params._id) // `http://localhost:3000/api/v1/borghi/${params._id}`
              );
            case 5:
            ...
            case 13:
              ...
              console.error("Errore durante il fetching dei borghi:", _context2.t0);
            case 16:
              _context2.prev = 16;
              setIsLoading(false);
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            console.error("Errore:", _context3.t0);
