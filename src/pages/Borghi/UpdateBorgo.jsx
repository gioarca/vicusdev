...
//               <h1 className="text-3xl font-bold text-white">{borghi.name}</h1>
//               <p className="text-sm text-white/80 mt-1">
//                 {t("modificaBorgo", "Modifica informazioni")}
//               </p>
//             </div>
//           </div>
//         </div>
...
//                 type="submit"
//                 disabled={!isFormModified}
//                 className="w-full md:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md transition-colors duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
//               >
//                 {isFormModified ? "Salva Modifiche" : "Nessuna Modifica"}
//               </button>
//             </div>
